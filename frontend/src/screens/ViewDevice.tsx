...
const ViewDevice: React.FC = () => {
  ...
  const loadDeviceHistory = async (deviceId: string) => {
    try {
      ...
      console.log("ViewDevice: Fetching movement for deviceId:", deviceId);
      const { movement } = await fetchDeviceMovement(deviceId);
      console.log("ViewDevice: Device Movement Response:", movement?.length || "No entries");
  ...
  return (
    ...
    >
      ...
      <DeviceHistoryPopup
        ...
        onClose={() => {
          console.log("ViewDevice: Closing history popup");
        ...
        onSelectLocation={(location) => {
          console.log("ViewDevice: Selected location:", location);
