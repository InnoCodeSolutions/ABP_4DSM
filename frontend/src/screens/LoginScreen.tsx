        ...
        >
          <ThemedView style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setResetEmail("")} style={{marginRight: 10}}>
                <Icon name="close" size={24} color={Platform.OS === "web" ? "#000" : undefined} />
              </TouchableOpacity>
            </View>
            <TextInput
            ...
            <View style={styles.modalButtonContainer}>
              ...
              >
                <ThemedText style={styles.modalSendText}>Enviar</ThemedText>
              </TouchableOpacity>
            </View>
          </ThemedView>
        </KeyboardAvoidingView>
